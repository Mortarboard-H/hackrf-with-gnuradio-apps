...
class jammer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_bias = freq_bias = 0
        self.center_freq = center_freq = target_center

        ##################################################
        # Blocks
        ##################################################
        self._freq_bias_range = Range(-1e5, 1e5, 1, 0, 200)
        self._freq_bias_win = RangeWidget(self._freq_bias_range, self.set_freq_bias, "'freq_bias'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_bias_win)
        ...
        self.osmosdr_sink_0.set_center_freq((center_freq+freq_bias), 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\admin\\Desktop\\gnuradio applications\\data\\real_rand_10MHz_0Hz_30secfloat.bin', True, 0, 0)
    ...
    def set_freq_bias(self, freq_bias):
        ...
        self.osmosdr_sink_0.set_center_freq((self.center_freq+self.freq_bias), 0)
