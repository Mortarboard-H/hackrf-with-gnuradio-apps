...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'E:\\raw_data_hackrf\\2.bin', False)
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.blocks_throttle_0, 0))
