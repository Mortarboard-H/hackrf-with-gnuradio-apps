...
class signal_analyser(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_analyser")
        ...
        self.osmosdr_source_0.set_bandwidth(4.75e6, 0)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'E:\\raw_data_hackrf\\gps_2022_09_09.dat', False)
...
def main(top_block_cls=signal_analyser, options=None):
